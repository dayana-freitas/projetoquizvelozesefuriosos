...
int main() {
    ...
    // REC_ALEATORIO
    int at = numquestoes, vet[at], resposta, roman, toretto, brian, han, personagem;
    generate(vet, at);
    ...
    for (int i = 1; i <= numquestoes; i++) {
        ...
        do {
            ...
            // case para definir o personagem "escolhido" na resposta a pergunta
            switch (resposta) {
            ...
            // case para atribuir a pontuação para cada personagem conforme as respostas
            switch (personagem) {
                case 1: roman++;
                    break;
                case 2: toretto++;
    ...
    printf("\n\n Roman: %d\n Toretto: %d\n Brian: %d\n Han: %d\n\n", roman, toretto, brian, han);

    // Apenas um personagem como resposta
    if (roman > toretto && roman > brian && roman > han) {
        printf("\n\n O personagem de velozes e furiosos com que você mais se parece é: Roman%d\n", roman);
    }
    else if (toretto > brian && toretto > han && toretto> roman) {
        printf("\n\n O personagem de velozes e furiosos com que você mais se parece é: Toretto: %d\n", toretto);
    } 
    else if (brian > toretto && brian > roman && brian > han) {
        printf("\n\n O personagem de velozes e furiosos com que você mais se parece é: Brian: %d\n", brian);
    }
    else if (han > toretto && han > roman && han > brian) {
        printf("\n\n O personagem de velozes e furiosos com que você mais se parece é: Han: %d\n", han);
    }

    // Dois personagens como resposta 
    else if (roman == toretto && roman != brian && roman != han && toretto != brian && toretto != han) {
        printf("\n\n Os personagens de velozes e furiosos com os quais você mais se parece são: Roman %d e Toretto %d\n", roman, toretto);
    }
    else if (roman == brian && roman != toretto && roman != han &&  brian != toretto && brian != han) {
        printf("\n\n Os personagens de velozes e furiosos com os quais você mais se parece são: Roman %d e Brian %d\n", roman, brian);
    }
    else if (roman == han && roman != toretto && roman != brian && han != brian && han != toretto ) {
        printf("\n\n Os personagens de velozes e furiosos com os quais você mais se parece são: Roman %d e Han %d\n", roman, han);
    }
    else if (toretto == han && toretto != roman && toretto != brian && han != brian && han != roman ) {
        printf("\n\n Os personagens de velozes e furiosos com os quais você mais se parece são: Toretto %d e Han %d\n", roman, han);
    }
    else if (toretto == brian && toretto != roman && toretto != han && brian != roman && brian != han ) {
        printf("\n\n Os personagens de velozes e furiosos com os quais você mais se parece são: Toretto %d e Han %d\n", roman, han);
    }
    else if (han == brian && han != roman && han != roman && brian != roman && brian != toretto ) {
        printf("\n\n Os personagens de velozes e furiosos com os quais você mais se parece são: Toretto %d e Han %d\n", roman, han);
    }
    ...
    // Três personagens como resposta
        ...
        printf("\n\n Os personagens de velozes e furiosos com os quais você mais se parece são: Roman %d, Toretto %d e Brian %d\n", roman, toretto, brian);
    }
    else if (roman == toretto && roman == han && roman != brian) {
        printf("\n\n Os personagens de velozes e furiosos com os quais você mais se parece são: Roman %d, Toretto %d e Han %d\n", roman, toretto, han);
    }
    else if (roman == brian && roman == han && roman != toretto) {
        printf("\n\n Os personagens de velozes e furiosos com os quais você mais se parece são: Roman %d, Brian %d e Han %d\n", roman, brian, han);
    }
    else if (toretto == brian && toretto == han && roman != toretto) {
        printf("\n\n Os personagens de velozes e furiosos com os quais você mais se parece são: Toretto %d, Brian %d e Han %d\n", toretto, brian, han);
    }
